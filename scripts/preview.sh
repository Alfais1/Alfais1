...
HTML
sed -e 's/github-markdown-dark.min.css/github-markdown-light.min.css/' -e 's/data-color-mode="dark" data-dark-theme="dark"/data-color-mode="light" data-light-theme="light"/' -e 's/background:#0d1117;color:#e6edf3/background:#ffffff;color:#1f2328/' -e 's/color:#8b949e;font-size/color:#59636e;font-size/' preview/index.html > preview/light.html
echo "preview/index.html + preview/light.html written"
